        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Strong Form is committed to work health and safety for everyone in the workplace and job site 
            ...
            <div className="bg-red-600 text-white p-6 rounded-xl mb-8 shadow-lg">
            ...
            <div className="space-y-4">
              ...
              {requirements.map((requirement, index) => (
                <div 
                  key={index}
                  className="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-red-50 transition-colors duration-300 group"
                >
                  <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center mr-4 flex-shrink-0 shadow-sm group-hover:bg-red-600 transition-colors duration-300">
                    <requirement.icon className="w-6 h-6 text-red-600 group-hover:text-white transition-colors duration-300" />
                  </div>
                  <div>
