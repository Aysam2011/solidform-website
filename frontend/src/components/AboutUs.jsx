        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Strong Form is a specialist formwork contractor that operates across NSW, ACT and now Victoria. 
            ...
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              Strong Form is a dynamic team that deliver capabilities of both conventional and modern formwork 
            ...
            <div className="grid grid-cols-2 gap-6">
              {features.map((feature, index) => (
                <div 
                  key={index}
                  className="flex flex-col items-start p-4 rounded-xl hover:bg-red-50 transition-colors duration-300 group"
                >
                  <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center mb-3 group-hover:bg-red-600 transition-colors duration-300">
